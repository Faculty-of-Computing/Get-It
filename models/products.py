from sqlalchemy import Integer, String,Float,DateTime,Boolean,Enum
...
class Products(db.Model):
    ...
    images:Mapped[List[str]] = mapped_column(JSONB, nullable=True)  #NOTE- Assuming images are stored as a comma-separated string
